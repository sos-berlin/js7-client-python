...
from ....api.joc.http.v_2_6_5.inventory.repository.delete import delete, EndpointCall
from ....util.version_to_tuple import version_to_tuple
from ....model.private.http.joc.joc_v_2_6_5 import (
    AuditParams as AuditParams_V_2_6_5,
    CommonConfigurationType as ConfigurationType_V_2_6_5,
    DeleteFromFilter as DeleteFromFilter_V_2_6_5,
    Category as Category_V_2_6_5,
    PublishConfiguration as PublishConfiguration_V_2_6_5,
    PublishConfig as PublishConfig_V_2_6_5
)
...
def _build_v_2_6_5_request(
    *, 
    ...
    res_configurations: List[PublishConfiguration_V_2_6_5] = [
        PublishConfiguration_V_2_6_5(
    ...
    # Result
    return DeleteFromFilter_V_2_6_5(
        configurations=[
            PublishConfig_V_2_6_5(configuration=c)
