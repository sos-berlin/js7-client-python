...
from ....api.joc.http.v_2_6_5.daily_plan.orders.cancel import cancel, EndpointCall
...
from ....model.private.http.joc.joc_v_2_6_5 import (
    ...
    DailyPlanCancelOrders as DailyPlanCancelOrders_V_2_6_5
)
...
def _build_v_2_6_5_request(filter: DailyPlanCancelOrdersFilter) -> DailyPlanCancelOrders_V_2_6_5:    
    # Result
    return DailyPlanCancelOrders_V_2_6_5(
