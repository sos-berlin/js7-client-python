...
from ....api.joc.http.v_2_6_5.daily_plan.orders.submit import submit, EndpointCall
from ....util.version_to_tuple import version_to_tuple
from ....model.private.http.joc.joc_v_2_6_5 import (
    Folder as Folder_V_2_6_5,
    DailyPlanSubmitOrders as DailyPlanSubmitOrders_V_2_6_5,
...
def _build_v_2_6_5_request(
    *,
    ...
    # Result
    return DailyPlanSubmitOrders_V_2_6_5(
