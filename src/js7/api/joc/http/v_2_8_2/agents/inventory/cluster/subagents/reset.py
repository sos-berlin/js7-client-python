...
from .........model.private.http.joc.joc_v_2_8_2 import SubAgentCommand, OK
...
def reset(call: EndpointCall) -> OK:
    ...
    if not isinstance(call.payload, SubAgentCommand):
        raise ValueError("'payload' is not an instance of model.http.joc_v_2_8_2.SubAgentCommand.")
...
ENDPOINT_DEFINITION = EndpointDefinition(
    id="agents/inventory/cluster/subagent/reset",
    function=reset,
    version=("2.6.5", "2.8.3"),
    payload_model=SubAgentCommand,
    response_model=OK,
    options=None
)