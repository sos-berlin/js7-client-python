...
from .........model.private.http.joc.joc_v_2_8_2 import StoreSubAgents, OK
...
def store(call: EndpointCall) -> OK:
    ...
    if not isinstance(call.payload, StoreSubAgents):
        raise ValueError("'payload' is not an instance of model.http.joc_v_2_8_2.StoreSubAgents.")
...
ENDPOINT_DEFINITION = EndpointDefinition(
    id="agents/inventory/cluster/subagents/store",
    function=store,
    version=("2.6.5", "2.8.3"),
    payload_model=StoreSubAgents,
    response_model=OK,
    options=None
)