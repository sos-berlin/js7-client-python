...
from .......model.private.http.joc.joc_v_2_8_2 import RoleRename, OK
...
def rename(call: EndpointCall) -> OK:
    ...
    if not isinstance(call.payload, RoleRename):
        raise ValueError("'payload' is not an instance of model.http.joc_v_2_8_2.RoleRename.")
    
    body = call.payload.model_dump_json(by_alias=True, exclude_none=True)
    
    with call.http_service as http:
        resp = http.post(
            path="/joc/api/iam/role/rename", 
            body=body,
            headers={
