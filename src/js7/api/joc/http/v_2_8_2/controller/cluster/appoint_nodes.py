...
from .......model.private.http.joc.joc_v_2_8_2 import URLParameter, OK


def appoint_nodes(call: EndpointCall) -> OK:
    ...
    with call.http_service as http:
        resp = http.post(
            path="/joc/api/controller/cluster/appoint_nodes", 
            body=body,
            headers={
...
ENDPOINT_DEFINITION = EndpointDefinition(
    id="controller/cluster/appoint_nodes",
    function=appoint_nodes,
    version=("2.6.5", "2.8.3"),
